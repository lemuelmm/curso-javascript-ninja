(function () {
  ...
  */
  function isOperatorValid(arg) {
    return operation[arg] !== undefined;
  }
  ...
  */
  function showErrorMessage(operator) {
    console.log("Operação \"" + operator + "\" não permitida!");
  }
  ...
  */
  ...
  if (min) {
    number1 = 10;
    number2 = 20;
    console.log(showOperationMessage(operationSignal, number1, number2), min(
      number1, number2));
  } else showErrorMessage(operationSignal);
  ...
  if (mult) {
    number1 = 10;
    number2 = 20;
    console.log(showOperationMessage(operationSignal, number1, number2), mult(
      number1, number2));
  } else showErrorMessage(operationSignal);
  ...
  if (div) {
    number1 = 10;
    number2 = 20;
    console.log(showOperationMessage(operationSignal, number1, number2), div(
      number1, number2));
  } else showErrorMessage(operationSignal);
  ...
  */
 operationSignal = 'o';
 var o = calculator(operationSignal);
 if (o) {
  number1 = 10;
  number2 = 20;
  console.log(showOperationMessage(operationSignal, number1, number2), o(
    number1, number2));
} else showErrorMessage(operationSignal);
